...
gdp_djia %>% 
  ...
  ggtitle("Correlation of GDP and DJIA")
...
Both the scatterplot and the correlation coefficient show that there is a strong positive correlation between the DJIA and GDP. So, as the DJIA increases, so does GDP. Visually, the scatterplot shows us that the is a pretty steady increase in DJIA as the GDP increases, though the DJIA decreases slightly at just over a GDP of 25000, but continues to increase after that. 
