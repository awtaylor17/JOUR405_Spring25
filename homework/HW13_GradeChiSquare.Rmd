...
I think the differences between the expected and observed frequencies are meaningful for the A's and C's because there is a difference of 20 between them. However, the differences in the other grade categories are smaller, so I'd say they are less meaningful. 
...
Yes, we do reject the null hypothesis because 11.667 > 9.487729. 
...
Overall, more students got higher grades than was expected. For example, the expected frequency for A's was 80, but the observed frequency was 100. A similar patter can be seen with C's, which was expected to be a frequency of 120, but was actually a frequency of 100. This also goes for F's, which were expected to be a frequency of 40, but were actually a frequency of 30. I would ask the instructor or the college about what tutoring and support resources they have and if any of these programs are new and could have influenced the student's grades. I would also ask about the turnover rate of instructors, or how often a class is taught by the same instructor. This is because a new instructor teaching the class (who may be a less-harsh grader) could influence the students' grades as well. 
