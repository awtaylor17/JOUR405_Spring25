...
I had trouble loading the tidyverse. At first, it gave me an error message saying that the tidyverse package was not installed. I googled some solutions, one of which was to use the install.packages("tidyverse") function. After I did that, it worked fine. 
