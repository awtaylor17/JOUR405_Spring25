...
One anomaly is a large drop in accidents a few months into 2020, though I'm fairly sure that is because of the pandemic. One pattern I noticed is that the number of daily accidents tends to go up and then go back down about twice a year. This can be seen in the small "hills" the data makes. One thing I'd like to look more into is why just before 2022 there was a day or two that have the highest and then the lowest amount of accidents. Why was that the case? I also think the pattern of rising and fall accident numbers could be a potential story idea. If it really is a consistent pattern what causes it and how can people prepare for it?
...
Friday and Saturday have the highest average of accidents. This is mostly likely because they are peak weekend days and days may people like to have a little too much to drink. The days with the lowest average of accidents are Monday and Wednesday. This is most likely because these are average work days where people mostly go to work then go back home, with nothing special in between. 
...
The date I chose was Nov. 11, 2021, which only had one reported accident. Based on my research, this was most likely because the Omicron variant of COVID-19 was starting to spread across the United States. So, most likely, people did not want to be out and about on that day. I would incorporate this context into a story by using COVID-19 case data to show that infections were on the rise. 
...
The overall extreme z-scores tend to have higher values than those adjusted for the day of the week. For example, the highest value in the overall list is 4.77, while the highest value in the day of week list is 4.17. Conversely, the lowest value in the day of the week list is 2.95, while the lowest in the overall list is -3.13. By looking at these two approaches to measuring unusual days, we can find different days that, under one approach, may not be as "unusual" as under a different approach.
...
The months with the highest average accidents are October, November and December, which are right around the holiday season. My guess is that accidents are up because lots of people are on the road traveling to visit their family. The lowest months are the winter months right after the holiday season. I would think this is because people are done traveling and the weather is getting colder, so less people are on the roads. 
...
Every extreme outlier is either a Friday, Saturday or Sunday, with the exception of Nov. 29, 2021, which is a Monday. 
...
Story pitch and reporting plan:
The story I want to report on is that the most accidents happen during the holiday season. I want to talk a psychologist and ask them why this might be. I'd ask them: "Do people drive more erratic during the holiday season or is the rise in accidents just because more people are on the road?" I'd also pose these questions to someone who works in traffic enforcement and who, most likely, deals with these accidents on each year. 

Headline:
Most car accidents in Prince George's County happen during the holidays. Why is that?

Lead:

October, November and December -- months filled with holidays -- have the highest number of average car accidents in Prince George's County, data shows.
