...
Overall, the data increases during the summer month and decreases during the winter. I would draw lines at 8 and 13, because that is they represent the edges of the IQR. 
...
All of these calls fall outside the lines I set in task 3. Though, they are farther outside of these lines than I expected. 
...
Tuesdays have the highest average call count when compared to the average call counts of every other day of the week. 
...
One potential angel for reporting would be to look into what could of caused two of the three days with the highest relative calls to be within a week of each other. What happened that week that contributed to this spike in overdose calls? To report this story, I would look for court records and news reports on drug stings that happened not long after those days. I'd also talk to police and people who work with drug users to see if there was a rise in drug activity or some other unusual activity that happened that week. I would tell an editor that looking into this could uncover previously unknown drug activity in Baltimore County. 
