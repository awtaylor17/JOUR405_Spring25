...
The actual amount of 5-star movies and 3-star movies are less than what we expected. On the other hand, the amount of 4-star, 2-star and 1-star movies are greater than what we expected. Overall the differences between what we expect and what we observed are usually not that large. 
...
We would reject the null hypothesis because the chi-square, 9.95, is greater than the critical value, 9.48. This means that the movies ratings we observed are significantly different from what we expected them to be.  
