...
```{r}
crimes_with_rate <- crimes %>% mutate(violent_rate = violent_crime_total/population * 10000, property_rate = property_crime_total/population * 10000)
```
...
The lowest crime rates were in more recent years, while higher crime rights were in older years. This pattern does not match what I thought because the rhetoric that we hear is that crime is getting worse. However, I am not surprised that crime was low in 2020 because people were isolated for most of that year. 
