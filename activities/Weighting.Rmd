...
The range of weights is from 0.2298 to 3.0386.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
When a respondent has a lower weight, it means that the pollsters have a larger sample of that type of person in the survey. When a respondent has a higher weight, it means that the pollsters have a smaller sample of that type of person in the survey. 

3. Why might some respondents be weighted more heavily than others?
Some responses might be weighted more because the pollster could had trouble finding people from that sub-group to survey.
...
The rarely/never category shows the biggest difference between their weighted and unweighted results. 

2. How might these differences affect reporting on likely voter turnout?
These differences would make it hard to predict voter turnout because the poll's sample may not have captured how the entire population would respond. So, we cannot reliably make predictions for that category.
...
I think these differences exist because the pollsters were not able to survey an entirely representative sample, so they had to make up for it in weighting the responses. It tells us that the rarely/never voters might be under-represented in the sample. 
